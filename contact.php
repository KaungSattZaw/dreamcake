...
<html lang="en">
    <head>
        ...
        <title>Dreaming food - Contact Page</title>
...
?>
                            ...
                            <form class="custom-form contact-form row" action="#" method="post" role="form">
                                ...
                                <div class="col-lg-6 col-6">
                                    ...
                                    <input type="telephone" name="t3" id="t3" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" placeholder="123-456-7890">
                                </div>

                                <div class="col-12"><label for="contact-message" class="form-label">Message</label>
                                    <textarea class="form-control" rows="5" id="t4" name="t4" placeholder="Your Message"
                                </textarea>
                                </div>
                        ...
                        <div class="col-lg-4 col-12 mx-auto mt-lg-5 mt-4">
                            ...
                            <div class="d-flex mb-lg-3">
                                ...
                                <p class="ms-5">8:00 AM - 10:00 PM</p>
                            </div>
                            ...
                            <div class="d-flex">
                                ...
                                <p class="ms-5">24 Hours Open</p>
                            </div>
                        </div>

                        <div class="col-12">
                            <h4 class="mt-5 mb-4">No.14 , U Tun Lin Chan Street, Kamayunt Township,Yangon, Myanmar</h4>

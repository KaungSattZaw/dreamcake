    ...
    <body>
            ...
            <header class="site-header site-news-detail-header">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2>Registaion for the Best Feature</h2>
                        </div>
        ...
        <form class="booking-form row" role="form" action="#" method="post">
            ...
            <div class="col-lg-6 col-12">
                ...
                <input type="password" name="your password" id="people" class="form-control" >
            </div>
            ...
            <div class="col-lg-6 col-12">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="City" required>
            </div>

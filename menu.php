    ...
    <body>
        ...
        <main>
            ...
            <section class="menu section-padding">
              ...
              echo "
              <td height='auto' width='100%' align='center'><img src='admin/image/$i' height='auto' width='100%'><br/>
             ...
             $n++;
               ...
               ?>s
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    <h4 class="mb-0">Fresh Start</h4><!----To Delete-->

                                    <span class="price-tag bg-white shadow-lg ms-4"><small>$</small>24.50</span><!----To Delete-->

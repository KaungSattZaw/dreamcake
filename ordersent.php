            ...
            <header class="site-header site-news-detail-header">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2>Thank you for shopping with us<?php echo "<font color=blue>".$_REQUEST['name']."</font>"; ?></h2>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-2">
                            <h4 class="mb-3">You have created your order successfully!!!</h4>

                            <a href="?log=out" class="custom-btn btn btn-dark mt-3">Log Out</a>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <p>Your order no. is <?php echo "<font size='4' color='blue'>".$_REQUEST['order_no']."</font>";?>, Thank you. Please come again.</p>

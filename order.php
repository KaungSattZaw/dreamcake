    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-white shadow-lg">
            <div class="container">
                ...
                <div class="d-none d-lg-block">
                    <a href="register.html" class="news-title-link">Registation</a>
                </div>
            ...
            <header class="site-header site-news-detail-header">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2>We are alway trying best for the coustomers, Have a good day.</h2>
                        </div>
        ...
        <form class="booking-form row" role="form" action="#" method="post">
            <div class="col-lg-6 col-12">
                ...
                <input type="text" name="prodno" id="prodno" class="form-control" value="<?php echo $mat['prod_no'];?>" placeholder="Your Name" required>
            </div>

            <div class="col-lg-6 col-12">
                <label for="name" class="form-label">Price</label>

                <input type="text" name="price" id="price" class="form-control" value="<?php echo $mat['price'];?>" placeholder="Price" required>
            </div>
            ...
            <div class="col-lg-6 col-12">
                <label for="date" class="form-label">Your Address</label>
            ...
            <div class="">
                <button name="ord" id="ord" type="submit" class="form-control">Submit Request</button>
            </div>

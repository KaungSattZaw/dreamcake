        ...
        <nav class="navbar navbar-expand-lg bg-white shadow-lg">
            <div class="container">
                ...
                <div class="d-none d-lg-block">
                    <a href="news-detail.html" class="news-title-link">Registation</a>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 mx-auto">
                            <h1 class="text-white">Dreaming's Story</h1>

                            <strong class="text-white">We are alway trying best for the coustomers </strong>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-2">
                            <h4 class="mb-3">Dreaming Food Inn is founded by (HK), Since 2000 in Myanmar.</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="team-thumb">
                                ...
                                <div class="team-info">
                                    <h4 class="mt-3 mb-0">Hnin Hnin</h4>
                        ...
                        <div class="col-lg-4 col-12 my-lg-0 my-4">
                            <div class="team-thumb">
                                ...
                                <h4 class="mt-3 mb-0">Htar Htar</h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="team-thumb">
                                ...
                                <h4 class="mt-3 mb-0">Kaung Kaung</h4>

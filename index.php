                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 m-auto">
                            <div class="heroText">
                                ...
                                <h1 class="text-white mb-lg-5 mb-3">Dreaming food</h1>

                                <div class="c-reviews my-3 d-flex flex-wrap align-items-center">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <h4 class="text-white mb-0 me-3">full star => 5</h4>
                                    ...
                                    <p class="text-white w-100">From <strong>11,768+</strong> Customer Good Reviews</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>Ks</small>1800</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>Ks</small>2400</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>Ks</small>4500</span>

                                    <del class="ms-4"><small>Ks</small>1500</del>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>Ks</small>3800</span>

                                    <del class="ms-4"><small>Ks</small>1240</del>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>Ks</small>2000</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>Ks</small>3400</span>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-12 tooplate-mt30">
                        ...
                        <p class="copyright-text tooplate-mt60">Copyright © 2022 Dreaming Food Co., Ltd.
